            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <!-- tabel rangking -->
                        <br>
                        <h3 align="center">Tabel Perangkingan Kualitas Air "SPK WP"</h3>
                        <table id="example1" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    <th>Rangking</th>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?php
          ...
          echo "<p>Sungai dengan peringkat tertinggi adalah {$best_school} dengan skor {$best_score}.</p>";
          echo "<p>Sungai dengan peringkat terendah adalah {$worst_school} dengan skor {$worst_score}.</p>";
        ?>
      </div>
